  ...
  if (mobilesCat && laptopsCat && earbudsCat) {
    ...
    const b1 = await prisma.blog.upsert({
      ...
      create: {
        ...
        metaTitle: 'Apple iPhone 15 Pro Max Detailed Review & Buying Guide (2026)',
        metaDescription: 'Comprehensive research-based review and buying guide for the iPhone 15 Pro Max. Detailed specifications, pros, cons, camera analysis, and Amazon pricing.',
        featuredImage: 'https://images.unsplash.com/photo-1695048133142-1a20484d2569?w=1200&auto=format&fit=crop&q=80',
        content: `<h2>Direct Answer & Overview</h2><p>The <strong>Apple iPhone 15 Pro Max</strong> delivers noticeable improvements over prior generations, most notably the lightweight aerospace-grade titanium frame, the 3nm A17 Pro silicon, a 5x optical telephoto lens, and the transition to a universal USB-C port with USB 3 data transfer speeds.</p><h2>Key Specifications & Hardware Analysis</h2><p>Under the hood, the A17 Pro chip brings hardware-accelerated ray tracing and significant efficiency gains. The 6.7-inch Super Retina XDR OLED panel reaches up to 2,000 nits peak outdoor brightness with smooth 120Hz ProMotion adaptive refresh rates.</p><h2>Advantages & Strong Points</h2><ul><li>Noticeably lighter in-hand feel compared to the stainless steel iPhone 14 Pro Max.</li><li>Exceptional 4K 60fps ProRes video recording directly to external SSD drives.</li><li>Class-leading battery endurance for power users and creators.</li></ul><h2>Limitations & Trade-Offs</h2><ul><li>Premium price point compared to standard flagships.</li><li>25W maximum wired charging speed lags behind competitors.</li></ul><h2>Who It Is Suitable For</h2><p>Ideal for mobile videographers, iOS ecosystem power users, and buyers upgrading from an iPhone 12 or 13 series seeking top-tier camera versatility and USB-C convenience.</p><h2>Who Should Consider Alternatives</h2><p>Buyers looking for lightweight sub-$800 smartphones or users who prioritize ultra-fast 65W+ fast charging may prefer alternative Android flagship options.</p>`,
        specifications: p1.specifications,
        features: p1.features,
        pros: p1.pros,
        cons: p1.cons,
        conclusion: 'The iPhone 15 Pro Max remains one of the most capable premium smartphones available, balancing stellar battery longevity, pro-grade video features, and refined ergonomics.',
